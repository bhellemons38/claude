...
export default function BevestigingPage() {
  return (
    <div className="min-h-screen flex flex-col bg-zand">
      <SiteHeader />
      <main className="flex-1 max-w-3xl mx-auto w-full px-4 sm:px-7 py-10 sm:py-14">
...
function LoadingState() {
  return (
    <div className="flex flex-col items-center justify-center py-20 text-inkt-zacht">
      ...
      <p className="font-semibold">Bestelling ophalen…</p>
    </div>
  )
}
